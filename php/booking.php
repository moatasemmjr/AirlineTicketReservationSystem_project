...
<head>
  ...
  <link rel="stylesheet" href="../css/pbooking.css">
...
<body>
  ...
  <section id="php">
    ...
    if (isset($_GET['Book'])) {
      ...
      $result = oci_parse($conn, "SELECT F.Flight_name,F.Seats,T.Departure,T.Arrival,T.Travel_type,C.Departure_time,C.Arrival_time,D.Day,cp.Price 
      FROM flight_info F , travel_info T,time C,day_info D, cprice_info cp
  ...
  <section id="container">
    ...
    <div class="row">
      <div class="col-md-6 text-center fname">
        <h1><i class="fas fa-plane-departure"></i><?php echo $row[0]; ?></h1>
      </div>
      <div class="col-md-3 content ">
        <p class="lead"><strong>From: </strong><?php echo $row[2]; ?></p>
        <p class="lead"><strong>To: </strong><?php echo $row[3]; ?></p>
        <p class="lead"><strong>Departure time: </strong><?php echo $row[5]; ?></p>
        <p class="lead"><strong>Arrival time: </strong><?php echo $row[6]; ?></p>
      </div>
      <div class="col-md-3 content">
        <p class="lead"><strong>Type: </strong><?php echo $row[4]; ?></p>
        <p class="lead"><strong>Day: </strong><?php echo $row[7]; ?></p>
        <p class="lead"><strong>Flight name: </strong><?php echo $row[0]; ?></p>
        <p class="lead"><strong>Starting Price: </strong><i class="fa fa-inr" aria-hidden="true"></i><strong><?php echo $row[8]; ?></strong></p>
      </div>
    ...
    <div class="d-flex justify-content-center seatsinfo">
      <div class="d-flex flex-column">
        <div class="p-2 text-center">
          <h3>Enter the Number of seats</h3>
        </div>
  ...
  <section id="pform">
    ...
    <?php if (isset($_POST['s'])) { ?>
      <?php if ((int)$row[1] >= $_POST['Seatno'] && (int)$_POST['Seatno'] > 0) {
        $type = $_POST['class'];
        $row[1] = (int)$row[1] - (int)$_POST['Seatno'];
        $_SESSION['num'] = $_POST['Seatno'];
        ...
        <form class="Passengerform" action="realbooking.php?type=<?php echo $type; ?>" method="post">
          ...
          $_SESSION['seat'] = (int)$_POST['Seatno'];
          ?>
