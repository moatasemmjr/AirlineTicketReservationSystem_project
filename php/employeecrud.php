        ...
        <div class="d-flex table-data ">
          <table class="table table-striped table-light table-hover">
            ...
            <tbody id="tbody">
              ...
              $result = oci_parse($conn, "SELECT * FROM flight_info");
              oci_execute($result);
              ?>
              <?php
              while ($row = oci_fetch_array($result)) { ?>
                <tr>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[0]; ?></td>
                  <td data-id="<?php echo $row[1]; ?>"><?php echo $row[1]; ?></td>
                  <td data-id="<?php echo $row[2]; ?>"><?php echo $row[2]; ?></td>
                </tr>
              <?php
              };
              ?>
        ...
        <div class="d-flex table-data ">
          <table class="table table-striped table-light table-hover">
            ...
            <tbody id="tbody">
              ...
              $result = oci_parse($conn, "SELECT * FROM travel_info");
              oci_execute($result);
              ?>
              <?php
              while ($row = oci_fetch_array($result)) { ?>
                <tr>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[0]; ?></td>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[3]; ?></td>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[1]; ?></td>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[2]; ?></td>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[4]; ?></td>
                </tr>
              <?php
              }
              ?>
        ...
        <div class="d-flex table-data ">
          <table class="table table-striped table-light table-hover">
            ...
            <tbody id="tbody">
              ...
              $password = '123';
              $conn = oci_connect($user, $password, $dbstr);
              $result = oci_parse($conn, "SELECT * FROM cprice_info");
              oci_execute($result);
              ?>
              <?php
              while ($row = oci_fetch_array($result)) { ?>
                <tr>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[0]; ?></td>
                  <td data-id="<?php echo $row[0]; ?>"><i class="fas fa-rupee-sign"></i><?php echo " " . $row[2]; ?></td>
                  <td data-id="<?php echo $row[0]; ?>"><?php echo $row[1]; ?></td>
                </tr>
              <?php
              }
      ...
      <div class="d-flex table-data text-center">
        <table class="table table-striped table-light table-hover">
          ...
          <tbody id="tbody">
            ...
            oci_execute($te);
            $result = oci_parse($conn, "SELECT * FROM time");
            oci_execute($result);
            ?>
            <?php
            while ($row = oci_fetch_array($result)) { ?>
        ...
        <div class="d-flex table-data ">
          <table class="table table-striped table-light table-hover">
            ...
            <tbody id="tbody">
              ...
              $conn = oci_connect($user, $password, $dbstr);
              // $db = mysqli_connect('localhost', 'root', '', 'airlines system') or die("could not connect to database");
              $result = oci_parse($conn, "SELECT * FROM Day_info");
              oci_execute($result);
              ?>
              <?php
              while ($row = oci_fetch_array($result)) { ?>
        ...
        <div class="d-flex table-data ">
          <table class="table table-striped table-light table-hover">
            ...
            <tbody id="tbody">
              ...
              $result = oci_parse($conn, "SELECT * FROM class");
              oci_execute($result);
              ?>
              <?php
              while ($row = oci_fetch_array($result)) { ?>
