...
<body>
  <section class="header">
    ...
    <video autoplay loop class="video-bg" muted plays-inline>
      <source src="../video/videou.mp4" type="video/mp4">
    </video>
    ...
    <div class="row justify-content-center">
      <div class="col-md-3">
        <div class="card shadow style=" width:20rem";>
          <div class="inner">
            <img class="card-img-top" src="../img/temple.jpg" alt="">
          </div>
      ...
      <div class="col-md-3">
        <div class="card shadow style=" width:20rem";>
          <div class="inner">
            <img class="card-img-top" src="../img/kerala.jpg" alt="">
          </div>
          <div class="card-body text-center">
            <h5>Kerala</h5>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
      ...
      <div class="col-md-3">
        <div class="card shadow style=" width:20rem";>
          <div class="inner">
            <img class="card-img-top" src="../img/Mumbai.jpg" alt="">
          </div>
          <div class="card-body text-center">
            <h5>Mumbai</h5>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
      ...
      <div class="col-md-3">
        <div class="card shadow style=" width:20rem";>
          <div class="inner">
            <img class="card-img-top" src="../img/kashmir.jpg" alt="">
          </div>
          <div class="card-body text-center">
            <h5>Kashmir</h5>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
  ...
  <section id="promo">
    ...
    <div class="promotion">
      <video autoplay loop class="vid" muted plays-inline>
        <source src="../video/first-flight.mp4" type="video/mp4">
      ...
      <div class="row">
        ...
        <div class="col-md-3 footer-links">
          ...
          <ul>
            ...
            <li><i class="fa fa-phone" aria-hidden="true"></i><a href="../contactus.html">Contct us</a></li>
          </ul>
        </div>
