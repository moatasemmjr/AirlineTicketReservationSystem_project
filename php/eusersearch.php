      ...
      <section id="box">
        <div class="container text-center ">
          ...
          if (isset($_POST['Search'])) { ?>
            ...
            $query = "SELECT F.Flight_name,T.Departure,T.Travel_code,T.Arrival,C.Departure_time,C.Arrival_time,C.Time_ID,D.Day,D.Day_ID,U.Pname,U.paid_by
            ...
            (SELECT DISTINCT Time_ID FROM passenger_info WHERE  Pname LIKE '%$Pname%')
              ";
            $r_search = oci_parse($conn, $query);
            echo oci_execute($r_search);
            $r = array();
            $count = oci_fetch_all($r_search, $r);
            oci_execute($r_search);
            if ($count == 0) { ?>
                  ...
                  <div class="d-flex table-data ">
                    <table class="table table-striped table-light table-hover">
                      ...
                      <tbody id="tbody">
                        <?php
                        print_r('abood');
                        while ($row = oci_fetch_array($r_search)) { ?>
                          <tr>
